      ...
      <div className="w-full max-w-4xl rounded-lg bg-white p-6 shadow md:p-8">
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:gap-12">
          <div className="flex-1">
            ...
            <form className="mt-6 space-y-6" onSubmit={handleSignup} data-testid="signup-form">
          {error && (
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (!usernameEdited) {
                    setUsername(nextValue.trim().replace(/\s+/g, '_').toLowerCase())
                  }
                }}
            ...
            <div>
              ...
              <div className="mt-1 flex items-center rounded border border-gray-300 px-3 py-2">
          ...
          <p className="text-center text-sm">
            ...
            <a href="/login" className="text-azure text-azure-hover hover:underline">
              Sign in
            </a>
          </p>
            </form>
